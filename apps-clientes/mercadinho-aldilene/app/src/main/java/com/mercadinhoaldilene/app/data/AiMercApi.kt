package com.mercadinhoaldilene.app.data

import com.mercadinhoaldilene.app.BuildConfig
...
import com.mercadinhoaldilene.app.model.StoreInfo
...
object AiMercApi {
    private const val STORE_SLUG = "mercadinho-aldilene"
...
private fun JSONObject.toCustomerOrder() = CustomerOrder(
    ...
    cancellation = optJSONObject("cancellation")?.let { cancellation ->
        com.mercadinhoaldilene.app.model.CancellationInfo(
