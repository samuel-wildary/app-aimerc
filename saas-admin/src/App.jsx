...
function CreateStore({ close, onCreate }) {
  const [form, setForm] = useState({ name: '', owner: '', email: '', phone: '', city: 'Caucaia', state: 'CE', plan: 'PROFESSIONAL', monthlyPrice: 497, minimumOrder: 30, deliveryFee: 6, billingMethod: 'PIX', password: 'Mudar@2026' });
  const [error, setError] = useState('');
