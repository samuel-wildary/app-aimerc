...
ALTER TABLE products ADD COLUMN IF NOT EXISTS sale_mode TEXT NOT NULL DEFAULT 'AUTO';
ALTER TABLE products ADD COLUMN IF NOT EXISTS quantity_step DOUBLE PRECISION NOT NULL DEFAULT 0.1;
ALTER TABLE products ADD COLUMN IF NOT EXISTS catalog_stock DOUBLE PRECISION;
